...
<div class="row justify-content-center" style="margin-top: 20px;">
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary" style="margin-bottom: 1rem;">
                ...
                <div class="row">
                    <div class="col">
                        <h4 class="h5 align-middle m-0 font-weight-bold text-primary">
                            Form Tambah Kepala BLK
                        </h4>
                    </div>
                    <div class="col-auto">
                        <a href="<?= base_url('halkepala_blk') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                <form action="<?= base_url('halkepala_blk/add') ?>" method="post" enctype="multipart/form-data">
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="username">NIP Kepala BLK</label>
                    <div class="col-md-6">
                        <input value="" type="text" id="username" name="username" class="form-control" placeholder="NIP kepala_blk">                    
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="alamat_kepala_blk">Alamat</label>
                    <div class="col-md-6">
                        <input value="" type="text" id="alamat_kepala_blk" name="alamat_kepala_blk" class="form-control" placeholder="Alamat">
                    </div>
                </div>
                <div class="row form-group">
