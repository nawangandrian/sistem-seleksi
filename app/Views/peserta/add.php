        ...
        <div class="card shadow-sm border-bottom-primary" style="margin-bottom: 1rem;">
            <div class="card-header py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('halpeserta') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                <form action="<?= base_url('halpeserta/add') ?>" method="post" enctype="multipart/form-data">
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="username">NIP Peserta</label>
                    <div class="col-md-6">
                        <input value="" type="text" id="username" name="username" class="form-control" placeholder="NIP Peserta">                    
                ...
                <div class="row form-group" id="pelatihanInput" >
                    <label class="col-md-4 text-md-right" for="pelatihan_id">Pelatihan</label>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="nik_peserta">NIK Peserta</label>
                    <div class="col-md-6">
                        <input value="" type="number" id="nik_peserta" name="nik_peserta" class="form-control" placeholder="NIK Peserta">
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="tgl_lahir_peserta">Tanggal Lahir Peserta</label>
                    <div class="col-md-6">
                        <input value="" type="date" id="tgl_lahir_peserta" name="tgl_lahir_peserta" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="jk">Jenis Kelamin</label>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="kota">Kota</label>
                    <div class="col-md-6">
                        <input value="" type="text" id="kota_peserta" name="kota_peserta" class="form-control" placeholder="Kota">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="kecamatan">Kecamatan</label>
                    <div class="col-md-6">
                        <input value="" type="text" id="kecamatan" name="kecamatan" class="form-control" placeholder="Kecamatan">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="desa">Desa</label>
                    <div class="col-md-6">
                        <input value="" type="text" id="desa" name="desa" class="form-control" placeholder="Desa">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="rw">RW</label>
                    <div class="col-md-6">
                        <input value="" type="number" id="rw" name="rw" class="form-control" placeholder="RW">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="rt">RT</label>
                    <div class="col-md-6">
                        <input value="" type="number" id="rt" name="rt" class="form-control" placeholder="RT">
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="" type="number" id="no_telp" name="no_telp" class="form-control" placeholder="Nomor Telepon">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="pelatihan_sebelumnya">Pernah Mengikuti Pelatihan?</label>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="status_pekerjaan">Status Pekerjaan</label>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="status_tni_asn_polri">Status TNI/Polri/ASN</label>
                    <div class="col-md-6">
