        ...
        <table class="table table-striped w-100 dt-responsive nowrap" id="dataTable" name="<?= $judul; ?>">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Jumlah Peserta Seleksi</th>
                    ...
                    if ($pelatihan) :
                        foreach ($pelatihan as $b) :
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('halpeserta/peserta/'. $b['id_pelatihan']) ?>" class="btn btn-circle btn-primary btn-sm"><i class="fa fa-folder-open"></i></a>
                                    <a data-bs-toggle="modal" data-bs-target="#modalEmail" data-pelatihan_id="<?= $b['id_pelatihan']; ?>" class="btn btn-success text-white btn-circle btn-sm"><i class="fa fa-message"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                <?php else : ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin mengirimkan notifikasi hasil seleksi administratif ke peserta?</p>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#btnKirimEmail').click(function() {
            ...
            $.ajax({
                url: '<?= base_url("Halemail/kirimSeleksiAdministratif") ?>',
                type: 'POST',
