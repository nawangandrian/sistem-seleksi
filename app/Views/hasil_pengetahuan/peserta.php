...
<div class="card shadow-sm border-bottom-primary" style="margin-bottom: 1rem;">
    <div class="card-header bg-white py-3">
        <div class="row">
            ...
            <div class="col-auto">
                <a href="<?= base_url('halhasilp') ?>" class="btn btn-sm btn-secondary btn-icon-split" id="addInput">
                    <span class="icon">
                ...
                if ($pelatihan) :
                    ...
                    foreach ($pelatihan as $b) :
                        ...
                        <tr>
                            ...
                            <td><?= isset($b['pengetahuan_hasil']) ? $b['pengetahuan_hasil'] : 'Belum ada hasil'; ?></td>
                            <td>
                                <a href="<?= base_url('halhasilp/hasil/' . $b['user_id'] . '/' . $b['pelatihan_id']) ?>" class="btn btn-circle btn-primary btn-sm"><i class="fa fa-folder-open"></i></a>
                            </td>
                    <?php endforeach; ?>
                <?php else : ?>
                    <tr>
