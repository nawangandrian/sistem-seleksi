...
<div class="row justify-content-center" style="margin-top: 20px;">
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary" style="margin-bottom: 1rem;">
            ...
            <div class="card-body">
                <form action="<?= base_url('halpelatihan/edit/'. $pelatihan->id_pelatihan) ?>" method="post" enctype="multipart/form-data">
                    <input value="<?= $pelatihan->id_pelatihan ?>" type="hidden" name="id_pelatihan" readonly="readonly" class="form-control">
                    <div class="row form-group">
                        <label class="col-md-4 text-md-right" for="nama_pelatihan">Nama pelatihan</label>
                        <div class="col-md-5">
                            <div class="input-group">
                                <input value="<?= $pelatihan->nama_pelatihan ?>" name="nama_pelatihan" id="nama_pelatihan" type="text" class="form-control" placeholder="Nama pelatihan..." required autofocus autocomplete="off"/>
                            </div>
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                <select name="jenis_pelatihan" id="jenis_pelatihan" class="custom-select">
                                    ...
                                    <?php if ($pelatihan->jenis_pelatihan == 'DBHCHT') { ?>
                                        <option value="DBHCHT" selected>DBHCHT</option>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                <input value="<?= $pelatihan->lama_pelatihan ?>" name="lama_pelatihan" id="lama_pelatihan" type="number" class="form-control" placeholder="Tanggal Mulai..." required autofocus autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                <input value="<?= $pelatihan->jumlah_peserta ?>" name="jumlah_peserta" id="jumlah_peserta" type="number" class="form-control" placeholder="Tanggal Selesai..." required autofocus autocomplete="off">
                            </div>
                        </div>
                    </div>
