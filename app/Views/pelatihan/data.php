...
<div class="card shadow-sm border-bottom-primary" style="margin-bottom: 1rem;">
    <div class="card-header bg-white py-3">
        <div class="row">
            ...
            <div class="col-auto">
                <a href="<?= base_url('halpelatihan/add') ?>" class="btn btn-sm btn-primary btn-icon-split">
                    <span class="icon">
                ...
                <?php
                    ...
                    if ($pelatihan) :
                        foreach ($pelatihan as $b) :
                            ...
                            <tr>
                                <td><?= $no++; ?></td>
                                <td><?= $b['nama_pelatihan']; ?> <?= $b['tahun_pelatihan']; ?></td>
                                ...
                                <td>
                                    <a href="<?= base_url('halpelatihan/edit/'. $b['id_pelatihan']) ?>" class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a>
                                    <a onclick="return confirm('Yakin ingin hapus?')" href="<?= base_url('halpelatihan/delete/'. $b['id_pelatihan']) ?>" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                <?php else : ?>
