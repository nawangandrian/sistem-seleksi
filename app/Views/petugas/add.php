...
<div class="row justify-content-center" style="margin-top: 20px;">
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary" style="margin-bottom: 1rem;">
            ...
            <div class="card-body">
                <form action="<?= base_url('halpetugas/add') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input value="" name="nama_petugas" id="nama_petugas" type="text" class="form-control" placeholder="Nama petugas..." required autofocus autocomplete="off"/>
                            </div>
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input value="" name="jabatan_petugas" id="jabatan_petugas" type="text" class="form-control" placeholder="Jabatan..." required autofocus autocomplete="off"/>
                            </div>
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input value="" name="no_telp_petugas" id="no_telp" type="text" class="form-control" placeholder="Nomor Telepon..." required autofocus autocomplete="off"s>
                            </div>
                        </div>
                    </div>
