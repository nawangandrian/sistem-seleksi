...
<div class="row justify-content-center" style="margin-top: 20px;">
    <div class="col-md-10">
        <div class="card shadow-sm border-bottom-primary" style="margin-bottom: 1rem;">
            ...
            <div class="card-body">
                <form action="<?= base_url('halsoalwawancara/edit/'. $soal->id_soal_wawancara . '/' . $nama_pelatihan->id_pelatihan) ?>" method="post" enctype="multipart/form-data">
                    <input value="<?= $soal->id_soal_wawancara ?>" type="hidden" name="id_soal_wawancara" readonly="readonly" class="form-control">
                    <div class="row form-group">
                        <label class="col-md-3 text-md-right" for="soal_wawancara">Soal</label>
                        <div class="col-md-7">
                            <div class="input-group">
                            <textarea name="soal_wawancara" id="soal_wawancara" class="form-control" rows="4" placeholder="soal..."><?= $soal->soal_wawancara ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row form-group">
                        <label class="col-md-3 text-md-right" for="bobot_soal_wawancara">Bobot Soal</label>
                        <div class="col-md-7">
                            <input value="<?= $soal->bobot_soal_wawancara ?>" type="number" id="bobot_soal_wawancara" name="bobot_soal_wawancara" class="form-control" placeholder="Bobot Soal">
                        </div>
                    </div>
                    <div class="row form-group">
