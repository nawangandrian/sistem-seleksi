        ...
        <div class="row">
            <div class="col">
                <h4 class="h5 align-middle m-0 font-weight-bold text-primary">
                    Data Soal <br> <?= $nama_pelatihan->nama_pelatihan ?>
                </h4>
            </div>
            <div class="col-auto">
                <a href="<?= base_url('halsoal') ?>" class="btn btn-sm btn-secondary btn-icon-split" id="addInput">
                    <span class="icon">
            ...
            <div class="col-auto">
                <a href="<?= base_url('halsoal/add/'.$nama_pelatihan->id_pelatihan) ?>" class="btn btn-sm btn-primary btn-icon-split">
                    <span class="icon">
                        ...
                        foreach ($soal as $b) :
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('halsoal/edit/'. $b['id_soal'].'/'.$nama_pelatihan->id_pelatihan) ?>" class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a>
                                    <a onclick="return confirm('Yakin ingin hapus?')" href="<?= base_url('halsoal/delete/'. $b['id_soal'].'/'.$nama_pelatihan->id_pelatihan) ?>" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                <?php else : ?>
            ...
            <label for="tipe_soal">Silahkan Download Template Import</label>
                    <div class="input-group">
                        <select onchange="downloadTemplate(this.value)" name="Template_Import" id="Template_Import" class="custom-select">
                            ...
                            <option value="<?= base_url('public/template_import_soal_pilgan.xlsx') ?>">Soal Pilihan Ganda</option>
                            <option value="<?= base_url('public/template_import_soal_benar_salah.xlsx') ?>">Soal Benar Salah</option>
                            <option value="<?= base_url('public/template_import_soal_uraian.xlsx') ?>">Soal Uraian</option>
                        </select>
                    </div>
            </div>
            <div class="form-group">
...
<script>
    function downloadTemplate(url) {
        if (url) {
            ...
            anchor.href = url;
            anchor.download = 'template_import_soal.xlsx'; 
            anchor.click(); 
        }
    }
</script>
