...
<div class="row justify-content-center" style="margin-top: 20px;">
    <div class="col-md-10">
        <div class="card shadow-sm border-bottom-primary" style="margin-bottom: 1rem;">
                ...
                <div class="row">
                    <div class="col">
                        <h4 class="h5 align-middle m-0 font-weight-bold text-primary">
                            Form Tambah Soal <br> <?= $nama_pelatihan->nama_pelatihan ?>
                        </h4>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <form action="<?= base_url('halsoal/add/'. $nama_pelatihan->id_pelatihan) ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-7">
                            <div class="input-group">
                                <textarea name="soal" id="soal" class="form-control" rows="4" placeholder="Soal..."></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-7">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <img src="<?= base_url('img/avatar/user.png')?>" alt="" class="img-thumbnail rounded mb-2">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-7">
                            <input value="" type="number" id="bobot_soal" name="bobot_soal" class="form-control" placeholder="Bobot Soal">
                        </div>
                    </div>
                    <div class="row form-group">
